...
public class PluginArenaManager {
  ...
  public void joinAttempt(@NotNull Player player, @NotNull IPluginArena arena) {
    ...
    if(arena.getArenaState() == IArenaState.IN_GAME || arena.getArenaState() == IArenaState.FULL_GAME) {
      arena.getPlayers().add(player);
      System.out.println(player.getName() + " is joining as spectator bc " + arena.getArenaState().getFormattedName());
  ...
  public void leaveAttempt(@NotNull Player player, @NotNull IPluginArena arena) {
    ...
    System.out.println(player.getName() + " is leaving");
